...
const footerLaunch = document.querySelector(".footer--launch");
...
const countdown = setInterval(() => {
    ...
    const footerDay = (document.querySelector(".footer--day"));
    const footerHour = (document.querySelector(".footer--hour"));
    const footerMin = (document.querySelector(".footer--min"));
